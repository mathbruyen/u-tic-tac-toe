...
var _gameStore = require('./game-store');

var _gameStore2 = _interopRequireDefault(_gameStore);

var dispatcher = (0, _dispatcher2['default'])();
var game = (0, _gameStore2['default'])(dispatcher);

_react2['default'].render(_react2['default'].createElement(_gameBox2['default'], { dispatch: dispatcher.dispatch, game: game }), document.body);

},{"./dispatcher":5,"./game-box":6,"./game-store":7,"react":161}],2:[function(require,module,exports){
...
var _crossPlayer = require('./cross-player');

var _crossPlayer2 = _interopRequireDefault(_crossPlayer);

var _circlePlayer = require('./circle-player');

var _circlePlayer2 = _interopRequireDefault(_circlePlayer);

var players = [_crossPlayer2['default'], _circlePlayer2['default']];

var CellBox = (function (_React$Component) {
  function CellBox(props) {
    var _this = this;

    _classCallCheck(this, CellBox);

    _get(Object.getPrototypeOf(CellBox.prototype), 'constructor', this).call(this, props);
    var getState = function getState() {
      return _this.props.game.getGame(_this.props.x, _this.props.y);
    };
    this.state = getState();
    this._onChange = function () {
      if (_this.props.x < _this.props.game.getSize() && _this.props.y < _this.props.game.getSize()) {
        _this.setState(getState());
      }
    };
  }

  _inherits(CellBox, _React$Component);
  ...
  _createClass(CellBox, [{
    ...
    value: function render() {
      ...
      if (this.state.isWonBy < 0) {
        var tbody = _react2['default'].DOM.tbody(null, this.props.game.generateRow(function (y) {
          return _this2._makeRow(y);
        }));
        return _react2['default'].DOM.table({ className: this.state.canPlayIn ? 'playable' : 'locked' }, tbody);
      } else {
        return _react2['default'].createElement(players[this.state.isWonBy]);
      }
    }
  }, {
    key: '_makeRow',
    value: function _makeRow(y) {
      var _this3 = this;

      return _react2['default'].DOM.tr({ key: y }, this.props.game.generateRow(function (x) {
        return _this3._makeCell(x, y);
      }));
    }
  }, {
    key: '_makeCell',
    value: function _makeCell(x, y) {
      var _this4 = this;

      var owner = this.state.cells[y][x];
      if (owner < 0) {
        if (this.state.canPlayIn) {
          return _react2['default'].DOM.td({ key: x, onClick: function onClick() {
              return _this4._playCell(x, y);
            }, style: { cursor: 'pointer' } });
        } else {
          return _react2['default'].DOM.td({ key: x });
        }
      } else {
        return _react2['default'].DOM.td({ key: x }, _react2['default'].createElement(players[owner]));
      }
    }
  }, {
    key: '_playCell',
    value: function _playCell(cellx, celly) {
      this.props.dispatch({ action: 'PLAYED_CELL', gamex: this.props.x, gamey: this.props.y, cellx: cellx, celly: celly });
    }
  }]);
...
exports['default'] = CellBox;
module.exports = exports['default'];

},{"./circle-player":3,"./cross-player":4,"react":161}],3:[function(require,module,exports){
/* jshint node: true, esnext: true */
...
var CirclePlayer = (function (_React$Component) {
  ...
  _inherits(CirclePlayer, _React$Component);

  _createClass(CirclePlayer, [{
    key: 'render',
    value: function render() {
      return _react2['default'].DOM.div(null, 'O');
    }
  }]);
...
var CrossPlayer = (function (_React$Component) {
  function CrossPlayer() {
    _classCallCheck(this, CrossPlayer);
  ...
  _inherits(CrossPlayer, _React$Component);

  _createClass(CrossPlayer, [{
    key: 'render',
    value: function render() {
      return _react2['default'].DOM.div(null, 'X');
    }
  }]);
...
var _cellBox = require('./cell-box');

var _cellBox2 = _interopRequireDefault(_cellBox);

var _statusBox = require('./status-box');

var _statusBox2 = _interopRequireDefault(_statusBox);

var GameBox = (function (_React$Component) {
  function GameBox(props) {
    var _this = this;

    _classCallCheck(this, GameBox);

    _get(Object.getPrototypeOf(GameBox.prototype), 'constructor', this).call(this, props);
    var getState = function getState() {
      return { size: _this.props.game.getSize() };
    };
    this.state = getState();
    this._onChange = function () {
      _this.setState(getState());
  ...
  _inherits(GameBox, _React$Component);
  ...
  _createClass(GameBox, [{
    ...
    value: function render() {
      ...
      return _react2['default'].DOM.div(null, _react2['default'].createElement(_statusBox2['default'], { game: this.props.game, dispatch: this.props.dispatch }), _react2['default'].DOM.table(null, _react2['default'].DOM.tbody(null, this.props.game.generateRow(function (y) {
        return _this2._makeGameRow(y);
      }))), _react2['default'].DOM.input({ type: 'number', step: 1, min: 1, max: 6, value: this.state.size, onChange: function onChange(e) {
          return _this2._changeSize(e);
        } }), _react2['default'].DOM.button({ onClick: function onClick() {
          return _this2._startGame();
        } }, 'Start new game'));
    }
  }, {
    key: '_makeGameRow',
    value: function _makeGameRow(y) {
      var _this3 = this;

      return _react2['default'].DOM.tr({ key: y }, this.props.game.generateRow(function (x) {
        return _this3._makeGame(x, y);
      }));
    }
  }, {
    key: '_makeGame',
    value: function _makeGame(x, y) {
      return _react2['default'].DOM.td({ key: x }, _react2['default'].createElement(_cellBox2['default'], { game: this.props.game, dispatch: this.props.dispatch, x: x, y: y }));
    }
  }, {
    key: '_startGame',
    ...
    key: '_changeSize',
    value: function _changeSize(event) {
      ...
      if (!isNaN(size)) {
        this.props.dispatch({ action: 'NEW_GAME_STARTED', size: size });
      }
    }
  }]);
...
},{"./cell-box":2,"./status-box":162,"react":161}],7:[function(require,module,exports){
/* jshint node: true, esnext: true */
...
exports['default'] = function (dispatcher) {
  ...
  function generateGrid(fn) {
    return generateRow(function (y) {
      return generateRow(function (x) {
        return fn(x, y);
      });
    });
  }
  ...
  var _newStore = (0, _store2['default'])(dispatcher, {
    NEW_GAME_STARTED: function NEW_GAME_STARTED(action) {
      start(action.size);
    },
    PLAYED_CELL: function PLAYED_CELL(action) {
      var game = ultimate.cells[action.gamey][action.gamex],
          i,
          j,
          t;
      game.cells[action.celly][action.cellx] = ultimate.turn;

      if (isWinning(game, function (x) {
        return ultimate.turn === x;
      }, action.cellx, action.celly)) {
        game.isWonBy = ultimate.turn;
        if (isWinning(ultimate, function (x) {
          return ultimate.turn === x.isWonBy;
        }, action.gamex, action.gamey)) {
  ...
  var onChange = _newStore.onChange;
  var offChange = _newStore.offChange;

  start(3);

  return { onChange: onChange, offChange: offChange, getTurn: getTurn, isDraw: isDraw, getWinner: getWinner, getGame: getGame, generateRow: generateRow, getSize: getSize };
};

module.exports = exports['default'];

},{"./store":163}],8:[function(require,module,exports){
...
},{"./ReactMount":74,"./findDOMNode":122,"./focusNode":124}],10:[function(require,module,exports){
/**
 * Copyright 2013-2015 Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":22,"./EventPropagators":27,"./ExecutionEnvironment":28,"./FallbackCompositionState":29,"./SyntheticCompositionEvent":98,"./SyntheticInputEvent":102,"./keyOf":145}],11:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSProperty":11,"./ExecutionEnvironment":28,"./camelizeStyleName":113,"./dangerousStyleValue":117,"./hyphenateStyleName":137,"./memoizeStringOnly":147,"./warning":160,"_process":8}],13:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":32,"./PooledClass":33,"./invariant":139,"_process":8}],14:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":22,"./EventPluginHub":24,"./EventPropagators":27,"./ExecutionEnvironment":28,"./ReactUpdates":92,"./SyntheticEvent":100,"./isEventSupported":140,"./isTextInputElement":142,"./keyOf":145}],15:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Danger":19,"./ReactMultiChildUpdateTypes":76,"./invariant":139,"./setTextContent":154,"_process":8}],17:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":139,"_process":8}],18:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./DOMProperty":17,"./quoteAttributeValueForBrowser":151,"./warning":160,"_process":8}],19:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ExecutionEnvironment":28,"./createNodesFromMarkup":116,"./emptyFunction":119,"./getMarkupWrap":132,"./invariant":139,"_process":8}],20:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./keyOf":145}],21:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":22,"./EventPropagators":27,"./ReactMount":74,"./SyntheticMouseEvent":104,"./keyOf":145}],22:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./keyMirror":144}],23:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 *
...
},{"./emptyFunction":119,"_process":8}],24:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventPluginRegistry":25,"./EventPluginUtils":26,"./accumulateInto":110,"./forEachAccumulated":125,"./invariant":139,"./warning":160,"_process":8}],25:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":139,"_process":8}],26:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":22,"./invariant":139,"./warning":160,"_process":8}],27:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":22,"./EventPluginHub":24,"./accumulateInto":110,"./forEachAccumulated":125,"./warning":160,"_process":8}],28:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"./PooledClass":33,"./getTextContentAccessor":134}],30:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactPropTypeLocations":82,"./ReactPropTypes":83,"./invariant":139,"./warning":160,"_process":8}],32:[function(require,module,exports){
/**
...
},{"./invariant":139,"_process":8}],34:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"./ReactDOMClient":47,"./ReactDOMServer":54,"./ReactIsomorphic":72}],35:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactInstanceMap":71,"./findDOMNode":122,"./warning":160,"_process":8}],36:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":22,"./EventPluginHub":24,"./EventPluginRegistry":25,"./Object.assign":32,"./ReactEventEmitterMixin":65,"./ViewportMetrics":109,"./isEventSupported":140}],37:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactReconciler":85,"./flattenChildren":123,"./instantiateReactComponent":138,"./shouldUpdateReactComponent":156}],38:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./PooledClass":33,"./ReactFragment":67,"./traverseAllChildren":158,"./warning":160,"_process":8}],39:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":32,"./ReactComponent":40,"./ReactElement":61,"./ReactErrorUtils":64,"./ReactNoopUpdateQueue":78,"./ReactPropTypeLocationNames":81,"./ReactPropTypeLocations":82,"./emptyObject":120,"./invariant":139,"./keyMirror":144,"./keyOf":145,"./warning":160,"_process":8}],40:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactNoopUpdateQueue":78,"./emptyObject":120,"./invariant":139,"./warning":160,"_process":8}],41:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactDOMIDOperations":49,"./ReactMount":74}],42:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":139,"_process":8}],43:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":32,"./ReactComponentEnvironment":42,"./ReactCurrentOwner":44,"./ReactElement":61,"./ReactInstanceMap":71,"./ReactPerf":80,"./ReactPropTypeLocationNames":81,"./ReactPropTypeLocations":82,"./ReactReconciler":85,"./ReactUpdateQueue":91,"./emptyObject":120,"./invariant":139,"./shouldUpdateReactComponent":156,"./warning":160,"_process":8}],44:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":61,"./ReactElementValidator":62,"./mapObject":146,"_process":8}],46:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":28,"./ReactCurrentOwner":44,"./ReactDOMTextComponent":55,"./ReactDefaultInjection":58,"./ReactInstanceHandles":70,"./ReactMount":74,"./ReactPerf":80,"./ReactReconciler":85,"./ReactUpdates":92,"./findDOMNode":122,"./renderSubtreeIntoContainer":152,"./warning":160,"_process":8}],48:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./AutoFocusUtils":9,"./CSSPropertyOperations":12,"./DOMProperty":17,"./DOMPropertyOperations":18,"./EventConstants":22,"./Object.assign":32,"./ReactBrowserEventEmitter":36,"./ReactComponentBrowserEnvironment":41,"./ReactDOMButton":46,"./ReactDOMInput":50,"./ReactDOMOption":51,"./ReactDOMSelect":52,"./ReactDOMTextarea":56,"./ReactMount":74,"./ReactMultiChild":75,"./ReactPerf":80,"./ReactUpdateQueue":91,"./escapeTextContentForBrowser":121,"./invariant":139,"./isEventSupported":140,"./keyOf":145,"./shallowEqual":155,"./validateDOMNesting":159,"./warning":160,"_process":8}],49:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./CSSPropertyOperations":12,"./DOMChildrenOperations":16,"./DOMPropertyOperations":18,"./ReactMount":74,"./ReactPerf":80,"./invariant":139,"./setInnerHTML":153,"_process":8}],50:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedValueUtils":31,"./Object.assign":32,"./ReactDOMIDOperations":49,"./ReactMount":74,"./ReactUpdates":92,"./invariant":139,"_process":8}],51:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":32,"./ReactChildren":38,"./ReactDOMSelect":52,"./warning":160,"_process":8}],52:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedValueUtils":31,"./Object.assign":32,"./ReactMount":74,"./ReactUpdates":92,"./warning":160,"_process":8}],53:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":28,"./getNodeForCharacterOffset":133,"./getTextContentAccessor":134}],54:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactDefaultInjection":58,"./ReactServerRendering":89}],55:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./DOMPropertyOperations":18,"./Object.assign":32,"./ReactComponentBrowserEnvironment":41,"./ReactDOMComponent":48,"./escapeTextContentForBrowser":121,"./validateDOMNesting":159,"_process":8}],56:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedValueUtils":31,"./Object.assign":32,"./ReactDOMIDOperations":49,"./ReactUpdates":92,"./invariant":139,"./warning":160,"_process":8}],57:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"./ReactUpdates":92,"./Transaction":108,"./emptyFunction":119}],58:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./BeforeInputEventPlugin":10,"./ChangeEventPlugin":14,"./ClientReactRootIndex":15,"./DefaultEventPluginOrder":20,"./EnterLeaveEventPlugin":21,"./ExecutionEnvironment":28,"./HTMLDOMPropertyConfig":30,"./ReactBrowserComponentMixin":35,"./ReactComponentBrowserEnvironment":41,"./ReactDOMComponent":48,"./ReactDOMIDOperations":49,"./ReactDOMTextComponent":55,"./ReactDefaultBatchingStrategy":57,"./ReactDefaultPerf":59,"./ReactEventListener":66,"./ReactInjection":68,"./ReactInstanceHandles":70,"./ReactMount":74,"./ReactReconcileTransaction":84,"./SVGDOMPropertyConfig":93,"./SelectEventPlugin":94,"./ServerReactRootIndex":95,"./SimpleEventPlugin":96,"_process":8}],59:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMProperty":17,"./ReactDefaultPerfAnalysis":60,"./ReactMount":74,"./ReactPerf":80,"./performanceNow":150}],60:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"./ReactCurrentOwner":44,"_process":8}],62:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactCurrentOwner":44,"./ReactElement":61,"./ReactFragment":67,"./ReactPropTypeLocationNames":81,"./ReactPropTypeLocations":82,"./getIteratorFn":131,"./invariant":139,"./warning":160,"_process":8}],63:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElement":61,"./ReactInstanceMap":71,"./invariant":139,"_process":8}],64:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventPluginHub":24}],66:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventListener":23,"./ExecutionEnvironment":28,"./Object.assign":32,"./PooledClass":33,"./ReactInstanceHandles":70,"./ReactMount":74,"./ReactUpdates":92,"./getEventTarget":130,"./getUnboundedScrollPosition":135}],67:[function(require,module,exports){
(function (process){
/**
...
},{"./ReactElement":61,"./warning":160,"_process":8}],68:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMProperty":17,"./EventPluginHub":24,"./ReactBrowserEventEmitter":36,"./ReactClass":39,"./ReactComponentEnvironment":42,"./ReactDOMComponent":48,"./ReactEmptyComponent":63,"./ReactNativeComponent":77,"./ReactPerf":80,"./ReactRootIndex":87,"./ReactUpdates":92}],69:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactDOMSelection":53,"./containsNode":114,"./focusNode":124,"./getActiveElement":126}],70:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactRootIndex":87,"./invariant":139,"_process":8}],71:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"./ReactChildren":38,"./ReactClass":39,"./ReactComponent":40,"./ReactDOM":45,"./ReactElement":61,"./ReactElementValidator":62,"./ReactPropTypes":83,"./onlyChild":148,"_process":8}],73:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./DOMProperty":17,"./ReactBrowserEventEmitter":36,"./ReactCurrentOwner":44,"./ReactElement":61,"./ReactEmptyComponent":63,"./ReactInstanceHandles":70,"./ReactInstanceMap":71,"./ReactMarkupChecksum":73,"./ReactPerf":80,"./ReactReconciler":85,"./ReactUpdateQueue":91,"./ReactUpdates":92,"./containsNode":114,"./emptyObject":120,"./instantiateReactComponent":138,"./invariant":139,"./setInnerHTML":153,"./shouldUpdateReactComponent":156,"./validateDOMNesting":159,"./warning":160,"_process":8}],75:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactChildReconciler":37,"./ReactComponentEnvironment":42,"./ReactMultiChildUpdateTypes":76,"./ReactReconciler":85}],76:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"./invariant":139,"_process":8}],78:[function(require,module,exports){
(function (process){
/**
 * Copyright 2015, Facebook, Inc.
 * All rights reserved.
...
},{"./warning":160,"_process":8}],79:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":139,"_process":8}],80:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./keyMirror":144}],83:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":61,"./ReactFragment":67,"./ReactPropTypeLocationNames":81,"./emptyFunction":119}],84:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CallbackQueue":13,"./Object.assign":32,"./PooledClass":33,"./ReactBrowserEventEmitter":36,"./ReactInputSelection":69,"./Transaction":108}],85:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactDefaultBatchingStrategy":57,"./ReactElement":61,"./ReactInstanceHandles":70,"./ReactMarkupChecksum":73,"./ReactServerBatchingStrategy":88,"./ReactServerRenderingTransaction":90,"./ReactUpdates":92,"./emptyObject":120,"./instantiateReactComponent":138,"./invariant":139,"_process":8}],90:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CallbackQueue":13,"./Object.assign":32,"./PooledClass":33,"./Transaction":108,"./emptyFunction":119}],91:[function(require,module,exports){
(function (process){
/**
 * Copyright 2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":32,"./ReactCurrentOwner":44,"./ReactElement":61,"./ReactInstanceMap":71,"./ReactUpdates":92,"./invariant":139,"./warning":160,"_process":8}],92:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./CallbackQueue":13,"./Object.assign":32,"./PooledClass":33,"./ReactPerf":80,"./ReactReconciler":85,"./Transaction":108,"./invariant":139,"_process":8}],93:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":22,"./EventPropagators":27,"./ReactInputSelection":69,"./SyntheticEvent":100,"./getActiveElement":126,"./isTextInputElement":142,"./keyOf":145,"./shallowEqual":155}],95:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./EventConstants":22,"./EventListener":23,"./EventPluginUtils":26,"./EventPropagators":27,"./ReactMount":74,"./SyntheticClipboardEvent":97,"./SyntheticDragEvent":99,"./SyntheticEvent":100,"./SyntheticFocusEvent":101,"./SyntheticKeyboardEvent":103,"./SyntheticMouseEvent":104,"./SyntheticTouchEvent":105,"./SyntheticUIEvent":106,"./SyntheticWheelEvent":107,"./emptyFunction":119,"./getEventCharCode":127,"./invariant":139,"./keyOf":145,"./warning":160,"_process":8}],97:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"./PooledClass":33,"./emptyFunction":119}],101:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":139,"_process":8}],109:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":139,"_process":8}],111:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":28,"./createArrayFromMixed":115,"./getMarkupWrap":132,"./invariant":139,"_process":8}],117:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"./warning":160,"_process":8}],119:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":44,"./ReactInstanceMap":71,"./ReactMount":74,"./invariant":139,"./warning":160,"_process":8}],123:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./traverseAllChildren":158,"./warning":160,"_process":8}],124:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":28,"./invariant":139,"_process":8}],133:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":32,"./ReactCompositeComponent":43,"./ReactEmptyComponent":63,"./ReactNativeComponent":77,"./invariant":139,"./warning":160,"_process":8}],139:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ExecutionEnvironment":28}],141:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":139,"_process":8}],145:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":61,"./invariant":139,"_process":8}],149:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":28}],150:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./escapeTextContentForBrowser":121}],152:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactMount":74}],153:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":28,"./escapeTextContentForBrowser":121,"./setInnerHTML":153}],155:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":139,"_process":8}],158:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElement":61,"./ReactFragment":67,"./ReactInstanceHandles":70,"./getIteratorFn":131,"./invariant":139,"./warning":160,"_process":8}],159:[function(require,module,exports){
(function (process){
/**
 * Copyright 2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":32,"./emptyFunction":119,"./warning":160,"_process":8}],160:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./emptyFunction":119,"_process":8}],161:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./lib/Object.assign":32,"./lib/React":34,"./lib/deprecated":118,"_process":8}],162:[function(require,module,exports){
/* jshint node: true, esnext: true */
...
var StatusBox = (function (_React$Component) {
  function StatusBox(props) {
    var _this = this;

    _classCallCheck(this, StatusBox);

    _get(Object.getPrototypeOf(StatusBox.prototype), 'constructor', this).call(this, props);
    var getState = function getState() {
      if (_this.props.game.isDraw()) {
        return { message: 'Draw!' };
      } else if (_this.props.game.getWinner() >= 0) {
        return { message: players[_this.props.game.getWinner()] + ' won!' };
      } else {
        return { message: players[_this.props.game.getTurn()] + '\'s turn' };
      }
    };
    this.state = getState();
    this._onChange = function () {
  ...
  _inherits(StatusBox, _React$Component);
  ...
  _createClass(StatusBox, [{
    ...
    key: 'render',
    value: function render() {
      return _react2['default'].DOM.h1(null, this.state.message);
    }
  }]);
...
exports["default"] = function (dispatcher, actions) {
  ...
  return { onChange: onChange, offChange: offChange };
};
